  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className="relative inline-flex items-center p-2 text-sm font-medium text-center text-gray-600 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-300 rounded-lg transition-colors duration-200"
        type="button"
      >
        <FaBell className="w-5 h-5" />
        <div className="absolute block w-3 h-3 bg-red-500 border-2 border-white rounded-full -top-0.5 -right-0.5 animate-pulse"></div>
      </button>
      {open && (
        <div
